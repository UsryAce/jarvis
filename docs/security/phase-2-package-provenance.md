...
Generated: `2026-08-08T22:13:48Z`
Canonical machine record: [`phase-2-package-provenance.json`](phase-2-package-provenance.json)

This receipt records the completed blocking approval for the exact cryptography closure. The Playwright closure and Chromium source contract remain pending, so this receipt does not authorize installation or execution.
...
The Playwright package closure and package-declared Chromium source contract have a separate later blocking decision and remain **PENDING**. Chromium archive and executable bytes remain **ABSENT**. This approval does not approve Playwright or any Chromium source or bytes.
